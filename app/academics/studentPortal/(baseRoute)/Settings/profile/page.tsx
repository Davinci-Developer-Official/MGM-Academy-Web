    ...
    <div>
      ...
      <div className='w-[80%]  ml-[10%] lg:h-[700px] sm:h-[600px] mt-[5px] lg:flex lg:flex-row  sm:flex sm:flex-col    ' >
        <div className='lg:w-[300px] lg:h-[400px] sm:w-full sm:h-[100px]   rounded-tl-md border-r-0 rounded-bl-md flex lg:flex-col sm:flex-row bg-[#2d545e] ' >
          ...
          <Image src={ba} alt='Profile Image' className='object-fill h-full w-full rounded-md  '  />
          </span>
        ...
        <form className="flex flex-col justify-between h-[80%] my-auto  pt-[50px] text-[#2d545e] " >
           <div className='lg:flex lg:flex-row sm:flex sm:flex-col justify-evenly w-[96%] mx-auto text-center  ' >
            <p>Edit Names</p>
            <input type="text" placeholder='John Doe'  name="name" className=" pl-5 text-[#2d545e] placeholder-white h-[50px] bg-[#e1b382] rounded-md lg:w-[60%] sm:w-full border border-[#2d545e] border-t-0 border-l-0 border-r-0  " />
            </div>
           <div className='lg:flex lg:flex-row sm:flex sm:flex-col justify-evenly w-[96%] mx-auto text-center  ' >
            <p>Edit email</p>
            <input type="email" placeholder='johndoe@gmail.com' name="name" className=" pl-5 text-[#2d545e] placeholder-white h-[50px] bg-[#e1b382] rounded-md lg:w-[60%] sm:w-full border border-[#2d545e] border-t-0 border-l-0 border-r-0  " />
            </div>
           <div className='lg:flex lg:flex-row sm:flex sm:flex-col justify-evenly w-[96%] mx-auto text-center  ' >
            <p>Edit number</p>
            <input type="phonenumber" placeholder='+1 555-4323-3345' name="name" className=" pl-5 text-[#2d545e] placeholder-white h-[50px] bg-[#e1b382] rounded-md lg:w-[60%] sm:w-full border border-[#2d545e] border-t-0 border-l-0 border-r-0   " />
            </div>
            <div className='lg:flex lg:flex-row sm:flex sm:flex-col justify-evenly w-[96%] mx-auto text-center  ' >
      ...
      }}  placeholder="describe your self" name="name" className=" pl-5 text-[#2d545e] placeholder-white  bg-[#e1b382] rounded-md lg:w-[60%] sm:w-full border border-[#2d545e] border-t-0 border-l-0 border-r-0   " />
            </div>
           <div className='lg:flex lg:flex-row sm:flex sm:flex-col justify-evenly w-[96%] mx-auto text-center  ' >
            <p>Edit password</p>
            <input type="password" placeholder='*********'  name="name" className=" pl-5 text-[#2d545e] placeholder-white h-[50px] bg-[#e1b382] rounded-md lg:w-[60%] sm:w-full border border-[#2d545e] border-t-0 border-l-0 border-r-0   " />
            </div>
