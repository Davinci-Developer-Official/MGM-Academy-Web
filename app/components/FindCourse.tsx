...
const FindCourse = () => {
  ...
  return (
    ...
    <div>
      <button className="btn flex flex-row text-[#e1b382] bg-gradient-to-r from-[#2d545e] border border-[#e1b382] " onClick={openModal} >
        Find Course(s) <FaBinoculars />
      </button>
      {modalIsOpen && (
        <dialog
          id="my_modal_3"
          className="modal text-[#e1b382] bg-[#2d545e] w-[99%] mx-auto h-[99%] my-auto rounded-md flex flex-col"
          open
        >
          <button
          ...
          <div className="mb-2 text-xl pt-3 pb-3 text-bold ">MGM Courses</div>
          <Searchbar />
