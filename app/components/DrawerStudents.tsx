...
const DrawerStudent: React.FC = () => {
  ...
  <div className="drawer-content flex flex-col items-left justify-center">
    {/* Page content here */}
    <label htmlFor="my-drawer-2" className="btn btn-ghost drawer-button lg:hidden fixed top-16 ml-2 bg-[#e1b382] text-[#2d545e] "> <FaChevronCircleRight size={20} /> </label>
  
  </div> 
  <div className="drawer-side  ">
    <label htmlFor="my-drawer-2" aria-label="close sidebar" className="drawer-overlay"></label> 
    <ul className="menu  p-2 w-60 min-h-full h-screen text-white  h-screen flex flex-col "  style={{
